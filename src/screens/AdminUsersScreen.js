...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#fff", borderRadius: 12, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: "#f3e8d4" },
  ...
  button: { backgroundColor: "#b45309", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12 },
  buttonSecondary: { backgroundColor: "#0f766e", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12 },
  deleteButton: { backgroundColor: "#dc2626", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12 },
